...
let projectArgs =
    ...
    if RuntimeInformation.IsOSPlatform(OSPlatform.Windows) then
        ...
        [|  @"fsc.exe"
            ...
            @"--simpleresolution"
            "--nowin32manifest" 
            @"/Users/erik/Code/exercism/fsharp-test-runner/test/Exercism.TestRunner.FSharp.IntegrationTests/Solutions/MultipleTestsWithSingleFail/obj/Debug/net5.0/.NETCoreApp,Version=v5.0.AssemblyAttributes.fs"
            @"/Users/erik/Code/exercism/fsharp-test-runner/test/Exercism.TestRunner.FSharp.IntegrationTests/Solutions/MultipleTestsWithSingleFail/obj/Debug/net5.0/Fake.AssemblyInfo.fs"
            @"/Users/erik/Code/exercism/fsharp-test-runner/test/Exercism.TestRunner.FSharp.IntegrationTests/Solutions/MultipleTestsWithSingleFail/Fake.fs"
            @"/Users/erik/Code/exercism/fsharp-test-runner/test/Exercism.TestRunner.FSharp.IntegrationTests/Solutions/MultipleTestsWithSingleFail/FakeTests.fs"
         |]
